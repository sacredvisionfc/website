...
function openPaystackPayment() {
  Swal.fire({
    ...
    html: '\
      <div style="text-align:left;">\
        ...
        <div style="background:rgba(108,228,210,0.08);padding:14px 18px;border-radius:12px;border:1px solid rgba(108,228,210,0.15);margin-top:16px;">\
          <p style="margin:0;font-family:\'Bebas Neue\',sans-serif;font-size:.85rem;letter-spacing:.05em;color:var(--text);">Daily Rate: <strong style="color:var(--teal);">GHS 600/day</strong></p>\
    ...
    preConfirm: function() {
      ...
      var amount = calcPayment(600, weeks, payType);
